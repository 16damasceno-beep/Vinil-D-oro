        ...
        <div className="text-white space-y-6">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <div className="flex justify-between items-end mb-6">
              <div><span className="text-gray-400 text-xs block">Preço do Oferta</span><span className="text-3xl font-bold">R$ {listing.price.toFixed(2)}</span></div>
              {isLot && <div className="text-right"><span className="text-gray-400 text-xs block">Desconto</span><span className="text-green-400 font-bold">-{((1 - (listing.price / listing.lotConfig!.originalTotalPrice)) * 100).toFixed(0)}% OFF</span></div>}
            </div>
          ...
          {isLot && (
            <div className="space-y-3">
               <h3 className="font-bold border-b border-gray-700 pb-2">Itens inclusos neste Lote ({lotItems.length})</h3>
          ...
          <div>
            <h3 className="font-bold border-b border-gray-700 pb-2 mb-2">Descrição</h3>
